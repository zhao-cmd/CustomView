...
public class RegionView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //canvas.drawText("OK",0,0,textPaint);
        canvas.drawText("+",0,-mWidth/3-mWidth/18,textPaint);
        canvas.drawText("—",0,mWidth/3+mWidth/10,textPaint);
        canvas.drawText("<<",-mWidth/3-mWidth/12,0,textPaint);
        canvas.drawText(">>",mWidth/3+mWidth/12,0,textPaint);
